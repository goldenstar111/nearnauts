...
pub trait NonFungibleTokenCore {
	...
	//approve an account ID to transfer a token on your behalf --owner
    fn nft_approve_owner(&mut self, token_id: TokenId, account_id: AccountId, msg: Option<String>);
...
impl NonFungibleTokenCore for Contract {
	...
	//allow a specific account ID to approve a token on your behalf --owner
    #[payable]
    fn nft_approve_owner(&mut self, token_id: TokenId, account_id: AccountId, msg: Option<String>) {
        /*
            assert at least one yocto for security reasons - this will cause a redirect to the NEAR wallet.
    ...
    fn nft_revoke(&mut self, token_id: TokenId, account_id: AccountId) {
        ...
        assert_ne!(&predecessor_account_id, &token.owner_id);
