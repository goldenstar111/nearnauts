...
impl Contract {
    ...
    #[payable]
    pub fn remove_sale(&mut self, nft_contract_id: ValidAccountId, approval_id: AccountId ,token_id: String) {
        assert_at_least_one_yocto();
        let contract_id: AccountId = nft_contract_id.into();
        let sale = self.internal_remove_sale(contract_id.clone(), token_id.clone());
    ...
    pub fn process_purchase(
        ...
        //trended volume increase
        
        self.total_volume += u128::from(price).wrapping_div(10u128.pow(20));
